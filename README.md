...
**On the tech choices:** This project intentionally uses plain JavaScript over TypeScript, and raw SQL over an ORM. The goal was to build a solid understanding of the fundamentals first — how queries actually work, what an ORM abstracts away, and what TypeScript enforces — before reaching for tools that hide that complexity. Future projects will incorporate both.
